...
public class Dispatch extends JacobObject {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sap.smb.sbo.wrapper.com.JacobObject#safeRelease()
	 */
	@Override
	 ...
	 */
	private static void throwIfUnattachedDispatch(Object theOneInQuestion) {
		if (theOneInQuestion == null) {
			throw new IllegalArgumentException(
					"Can't pass in null Dispatch object");
		} else if (((Dispatch) theOneInQuestion).isAttached()) {
			return;
		} else {
	 ...
	 * 
	 */
	private native void do_release();
	 ...
	 * @param name
	 * @param val
	 * @throws com.sap.smb.sbo.wrapper.com.NotImplementedException
	 */
	public static void put_Casesensitive(Object dispatchTarget, String name,
			Object val) {
	 ...
	 * @param uArgErr
	 */
	public static void invokeSubv(Object dispatchTarget, String name,
	 ...
	 * @param uArgErr
	 */
	public static void invokeSubv(Object dispatchTarget, int dispID,
			int wFlags, Variant[] vArg, int[] uArgErr) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 * @throws com.sap.smb.sbo.wrapper.com.NotImplementedException
	 */
	public static Variant callN_CaseSensitive(Object dispatchTarget,
	 ...
	 */
	public static void callSubN(Object dispatchTarget, String name,
			Object... args) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 *            an array of argument objects
	 */
	public static void callSubN(Object dispatchTarget, int dispID,
			Object... args) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 */
	public static int getIDOfName(Object dispatchTarget, String name) {
	...
	public static native int[] getIDsOfNames(Object dispatchTarget, int lcid,
			String[] names);
	 ...
	 */
	// eliminated _Guid argument
	public static int[] getIDsOfNames(Object dispatchTarget, String[] names) {
	 ...
	 */
	public static Variant callN(Object dispatchTarget, String name,
			Object... args) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 * @return Variant returned by call
	 */
	public static Variant callN(Object dispatchTarget, int dispID,
			Object... args) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 */
	public static Variant invoke(Object dispatchTarget, String name,
	 ...
	 * @return Variant returned by invoke
	 */
	public static Variant invoke(Object dispatchTarget, int dispID,
			int wFlags, Object[] oArg, int[] uArgErr) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 */
	public static Variant call(Object dispatchTarget, String name) {
		throwIfUnattachedDispatch(dispatchTarget);
	...
	public static Variant call(Object dispatchTarget, String name,
			Object attribute) {
		throwIfUnattachedDispatch(dispatchTarget);
		return callN(dispatchTarget, name, new Object[] {attribute});
	}
	 ...
	 * @return Variant returned by underlying callN
	 */
	public static Variant call(Object dispatchTarget, int dispid) {
		throwIfUnattachedDispatch(dispatchTarget);
	...
	public static Variant call(Object dispatchTarget, int dispid,
			Object attribute) {
		throwIfUnattachedDispatch(dispatchTarget);
		return callN(dispatchTarget, dispid, new Object[] {attribute});
	}
	 ...
	 * @param val
	 */
	public static void put(Object dispatchTarget, String name, Object val) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 * @param val
	 */
	public static void put(Object dispatchTarget, String name, Object val, Object oArg) {
		throwIfUnattachedDispatch(dispatchTarget);
		invoke(dispatchTarget, name, Dispatch.Put, new Object[] { val, oArg },
				new int[1]);
	}
	 ...
	 * @param val
	 */
	public static void put(Object dispatchTarget, int dispid, Object val) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 */
	public static native Variant invokev(Object dispatchTarget, String name,
			int dispID, int lcid, int wFlags, Variant[] vArg, int[] uArgErr);
	 ...
	 * @return Variant returned by underlying invokev
	 */
	public static Variant invokev(Object dispatchTarget, String name,
			int wFlags, Variant[] vArg, int[] uArgErr) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 * @return Variant returned by underlying invokev
	 */
	public static Variant invokev(Object dispatchTarget, int dispID,
			int wFlags, Variant[] vArg, int[] uArgErr) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 * @param uArgErr
	 */
	public static void invokeSub(Object dispatchTarget, String name,
			int dispid, int lcid, int wFlags, Object[] oArg, int[] uArgErr) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 * @param uArgErr
	 */
	public static void invokeSub(Object dispatchTarget, int dispid,
			int wFlags, Object[] oArg, int[] uArgErr) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 * @param name
	 */
	public static void callSub(Object dispatchTarget, String name) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 * @param dispid
	 */
	public static void callSub(Object dispatchTarget, int dispid) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 */
	public static Variant get(Object dispatchTarget, String name) {
		throwIfUnattachedDispatch(dispatchTarget);
		return invokev(dispatchTarget, name, Dispatch.Get, NO_VARIANT_ARGS,
				NO_INT_ARGS);
	}

    public static Variant get(Object dispatchTarget, String name, Object oArg) {
    	throwIfUnattachedDispatch(dispatchTarget);
        return invokev(dispatchTarget, name, Dispatch.Get, 
        		new Variant[]{VariantUtilities.objectToVariant(oArg)}, NO_INT_ARGS);
    }
	 ...
	 * @return Variant returned by the request for retrieval of parameter
	 */
	public static Variant get(Object dispatchTarget, int dispid) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 * @param val
	 */
	public static void putRef(Object dispatchTarget, String name, Object val) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 * @param val
	 */
	public static void putRef(Object dispatchTarget, int dispid, Object val) {
		throwIfUnattachedDispatch(dispatchTarget);
	 ...
	 * @throws com.sap.smb.sbo.wrapper.com.NotImplementedException
	 */
	public static Variant get_CaseSensitive(Object dispatchTarget, String name) {
		throw new NotImplementedException("not implemented yet");
	}
	 ...
	 * @return 0 if the dispatch is still active and 1 if it has exited
	 */
	public static int hasExited(Object dispatchTarget) {
		throwIfUnattachedDispatch(dispatchTarget);
		return hasExited((Dispatch) dispatchTarget, 0, LOCALE_SYSTEM_DEFAULT);
	}
