...
import com.sap.smb.sbo.wrapper.com.Currency;
import com.sap.smb.sbo.wrapper.com.Variant;
import com.sap.smb.sbo.wrapper.com.VariantUtilities;
...
public class VariantTest extends BaseTestCase {
	 ...
	 * 79228162514264337593543950341.0) { com.sap.smb.sbo.wrapper.com.Variant dv = new
	 * com.sap.smb.sbo.wrapper.com.Variant(i, false) println i + " : " + dv.getDecimal() }
	 * 
	 */
